...
call s:hi ("Identifier",    15,    00)
call s:hi ("PreProc",       09,    00)
call s:hi ("Constant",      10,    00)
call s:hi ("Statement",     11,    00)
...
call s:hi ("Visual",        13,    07)
call s:hi ("Ignore",        07,    00)
call s:hi ("LineNr",        07,    00)
call s:hi ("SignColumn",    07,    00)
call s:hi ("NonText",       07,    00)
...
call s:hi ("jsFunction", 06, 00)
call s:hi ("jsStorageClass", 11, 00)
call s:hi ("jsString", 11, 00)
call s:hi ("jsFuncCall", 06, 00)
